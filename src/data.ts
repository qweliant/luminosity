...
export const EMOTION_PLACES: EmotionPlace[] = [
  {
    ...
    routesTo: 'nagoski',
    routeNote: 'Look at the Contexts step: what speeds this up, what slows it down.',
    emotions: [
      { name: 'Stress', note: 'Stress is taxed-but-navigable. Tactical: tooling, delegation, cuts.' },
      { name: 'Overwhelm', cessation: true, note: 'Cognitive shutdown. What you need is rest, not a plan. Silence and space until things settle.' },
      { name: 'Anxiety', note: 'Anticipation of a future threat. Ground in what is within your control.' },
      { name: 'Worry', note: 'A chain of "what if" thoughts. Name the specific feared outcome, then ask if you can do anything about it.' },
      { name: 'Avoidance', note: 'Side-stepping the source of discomfort. The Contexts step, under Brakes, is where this lives.' },
      { name: 'Excitement' },
  ...
  },
  {
    ...
    routesTo: 'jones',
    routeNote: 'Look at the Reframe and Contexts steps: what desire or boundary is underneath?',
    emotions: [
      { name: 'Comparison' },
      { name: 'Admiration', note: 'Like envy but generous. Often points to a value you already hold.' },
      { name: 'Reverence' },
      { name: 'Envy', note: 'Data about an unvoiced desire. Turn it into a small test: what would giving yourself permission look like?' },
      { name: 'Jealousy', note: 'Three-party: fearing loss of a relationship or resource to someone else. The Contexts step can help name what is at stake.' },
      { name: 'Resentment', note: 'Often envy, not anger: you are holding yourself to a standard someone else has put down. Look at the standard, not the other person.' },
      { name: 'Schadenfreude' },
      { name: 'Freudenfreude' },
    ],
  },
  {
    ...
    routeNote: 'Look at the expectation. Was it stated and shared, or unspoken?',
    emotions: [
      { name: 'Boredom' },
      { name: 'Disappointment', note: 'Was the expectation examined and expressed, or unexamined and unspoken? Which kind was this?' },
      { name: 'Expectations', note: 'Watch for stealth expectations, the ones you never voiced, even to yourself.' },
  ...
  },
  {
    id: 'hurting',
    label: "We're Hurting",
    blurb: 'When something is painful. These are not problems to solve, but experiences to move through.',
    routesTo: 'compassion',
    routeNote: 'No plan fits here. What is needed is presence, and time.',
    emotions: [
  ...
  },
  {
    ...
    routesTo: 'act',
    routeNote: 'For guilt, look at whether your actions match your values. For shame, that does not apply.',
    emotions: [
      { name: 'Shame', cessation: true, note: 'Shame says "I am bad," not "I did something bad." Self-compassion, not a plan.' },
      { name: 'Self-Compassion', note: 'The antidote that lives inside the same cluster.' },
      { name: 'Perfectionism', note: 'A brake disguised as a standard. Name it in the Contexts step.' },
      { name: 'Guilt', note: 'Adaptive: it points to behavior that strayed from a value. Realign the behavior, not the self.' },
      { name: 'Humiliation' },
      { name: 'Embarrassment' },
    ],
  },
  {
    ...
    emotions: [
      { name: 'Belonging', note: 'Belonging requires being your authentic self.' },
  ...
  },
  {
    ...
    routesTo: 'jones',
    routeNote: 'For the painful feelings here, the honesty check in the Contexts step is a good place to look.',
    emotions: [
      { name: 'Love' },
      { name: 'Lovelessness' },
      { name: 'Heartbreak' },
      ...
      { name: 'Betrayal' },
      { name: 'Defensiveness' },
      { name: 'Flooding', cessation: true, note: 'Your heart racing in conflict, too fast to think straight. Disengage. Return when calm.' },
      { name: 'Hurt' },
    ],
  },
  {
    ...
    routesTo: 'jones',
    routeNote: 'Try a boundary check in the Contexts step. If the target cannot change, shift toward acceptance instead.',
    emotions: [
      { name: 'Anger', note: 'If aimed at something you can change, you can act on it. If aimed at something you cannot, acceptance applies.' },
      { name: 'Contempt' },
      { name: 'Disgust' },
      { name: 'Dehumanization' },
      { name: 'Hate' },
